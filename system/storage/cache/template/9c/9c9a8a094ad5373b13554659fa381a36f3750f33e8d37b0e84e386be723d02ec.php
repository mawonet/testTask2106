...
/* user/user_form.twig */
class __TwigTemplate_6e8cd1dd22e91791053d41007460a130c2323f040592e8bb1035a5ea0c798263 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user_group"]) {
            // line 42
            echo "                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["user_group"], "user_group_id", [], "any", false, false, false, 42), ($context["user_group_id"] ?? null)))) {
                // line 43
                echo "                <option value=\"";
